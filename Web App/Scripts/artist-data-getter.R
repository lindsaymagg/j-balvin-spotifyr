...
# Takes approx 10 min for artist_df, 2.5 hrs for collaboration info, new-artists 3 min
library(dplyr)
library(tidyverse)
library(spotifyr)
library(plyr)
...
new_ids <- setdiff(edge_ids$target, artist_df$id)

print(Sys.time())
print("***Getting new artist info...***")
new_artists <- get_new_artists(new_ids)
print(Sys.time())
print("***Done getting new artist info...***")
...
# Next script to run: artist-network-creator.R
